...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Laravel_blog Dashboard</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">E-MAIL SERVICE</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="# ">Laravel Blog</a>.</strong>
    All rights reserved.
