...
@section('title', 'Category List & create-form')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Categories chapter</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Categories List & create-form</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-8">
            <div class="card card-warning">
              <div class="card-header">
                <h4>Data table with added *Categories</h4>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="text" placeholder="Enter category description">
                  </div>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-warning"><b>+ Add Category</b></button>
                </div>
                <div class="card-footer">
                    <button type="submit" class="btn btn-info">Form clear</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
